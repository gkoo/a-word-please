export default [
  {
    ...
    description: 'The witness chooses a scene tile to eliminate. The Forensic Scientist discards ' +
      'the indicated tile and replaces it with a random one.'
  },
  {
    title: 'A Good Twist',
  ...
  {
    title: 'Countdown',
    description: 'The Forensic Scientist draws two scene tiles and substitutes them for any 2 ' +
      'scene tiles in the display. The game ends after the following \'Presentation\' is finished.',
  },
];
