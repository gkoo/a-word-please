export const easyConcepts = [
  ...
  ['Etiquette', 'Manners'],
  ['Bop', 'Jam'],
  ['Movie Godzilla would improve', 'Movie Godzilla would ruin'],
  ['Unelectable', 'Electable'],
  ['Just one date', 'Marriage material'],
  ['Accurate', 'Inaccurate'],
  ['Gossip', 'News'],
  ['Basic', 'Awesome'],
  ['Winner', 'Loser'],
  ...
  ['Annoying sound', 'Wonderful sound'],
  ...
  ['Underrated activity', 'Overrated activity'],
  ['Hairless', 'Hairy'],
