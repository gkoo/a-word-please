...
import { activePlayerSelector, connectedPlayersSelector, gameDataSelector } from '../../store/selectors';
...
function PointsTable({ highlightPlayerId }) {
  ...
  const { pointsForPlayer } = gameData;

  const playersSortedByPoints = Object.values(connectedPlayers).sort((player1, player2) => {
