...
export const STATE_DECEPTION_CHOOSE_MEANS_EVIDENCE = 4;
export const STATE_DECEPTION_WITNESSING = 5;
export const STATE_DECEPTION_SCIENTIST_CAUSE_OF_DEATH = 6;
export const STATE_DECEPTION_SCIENTIST_LOCATION = 7;
export const STATE_DECEPTION_SCIENTIST_SCENE_TILES = 8;
export const STATE_DECEPTION_DELIBERATION = 9;
export const STATE_DECEPTION_REPLACE_SCENE = 10;
